...
@Component({
  selector: 'app-qry-order-charge',
  templateUrl: './qry-order-charge.component.html',
  styleUrls: ['./qry-order-charge.component.css']
})
export class QryOrderChargeComponent implements OnInit {
  ...
  searching() {
    ...
    this.service.SearchReport(FinanceReport.Report_OrderChargeSettleItemForAdminQueryAll, searchable).subscribe(result => {
