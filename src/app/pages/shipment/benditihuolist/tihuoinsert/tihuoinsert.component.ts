...
export class TihuoinsertComponent implements OnInit {
  ...
  constructor(private  dialogx: DialogservicesService, private groupInsideServiceService: ShipplanGroupInsideService, public emitService: EmitService, private logisticItemService: LogisticItemService, private itemServiceService: LogisticItemComponentService, private fb: FormBuilder, private route: ActivatedRoute) { }
