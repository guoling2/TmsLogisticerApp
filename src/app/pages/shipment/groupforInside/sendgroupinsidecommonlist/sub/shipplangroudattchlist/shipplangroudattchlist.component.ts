...
export class ShipplangroudattchlistComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private shipplanGroupInsideservices: ShipplanGroupInsideService, public dialogRef: MatDialogRef<ShipplangroudattchlistComponent>,
