...
export class DailyChargeSettleDetail   {
...
/// </summary>
  ...
  public DailyChargeSettleItems:DailyChargeSettleItemModel[];
  public LastUpdateDateTime ?: Date;
}

export class DailyChargeSettleItemModel {
  public  ChargeSettleItemId:string;
public  Methodcount :number;
public  Methodtype :string;
public  ChargeAmt :number;
public  BizHappendDateTime :Date;
public  DetailMark :string;
